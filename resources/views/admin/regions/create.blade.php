...
{{--                    <h3 class="panel-title">{{empty(1) ? 'New': 'Edit'}} User</h3>--}}
                ...
                {{--<div class="panel-body">--}}
                    ...
                    @endif
                        <form class="form-horizontalx" method="POST" action="{{route('settings.regions.create')}}" >
                            {{csrf_field()}}
                            {{ method_field('POST') }}
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <label>Code</label>
                                    <input name="code" type="text" value="{{ old('code')}}" class="form-control" placeholder="GRT-ACC">
                                </div>
